      ...
      <Layout>
        ...
        <View style={styles.selectRow}>
          <View style={styles.selectOption}>
            <Field name={'role'} boundValue={'employee'} setValue={() => this.props.change('role', 'employee')}
                   component={RadioButton}/>
            <Text style={styles.selectLabel}>Pracownik</Text>
          </View>
          <View style={styles.selectOption}>
            <Field name={'role'} boundValue={'student'} setValue={() => this.props.change('role', 'student')}
                   component={RadioButton}/>
